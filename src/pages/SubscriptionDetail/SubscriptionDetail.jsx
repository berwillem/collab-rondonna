...
import pdf1 from "../../assets/Contrat de Partenariat pour l'Inscription sur le Site Web Rondonna plan premuim.pdf"
import pdf2 from "../../assets/Contrat de Partenariat pour l'Inscription sur le Site Web Rondonna plan standard.pdf"
import pdf3 from "../../assets/Contrat de Partenariat pour l'Inscription sur le Site Web Rondonna.pdf"
...
export default function SubscriptionDetail() {
  ...
  const selectedPlan = subscriptionPlans.find(
    (plan) => plan.title.toLowerCase() === detail.toLowerCase()
  );
  ...
  const sendEmail = (e) => {
    ...
    formData.append(
      "payment_method",
      payement ? "Cash on delivery" : "Virement bancaire"
    );
      ...
      <div className="subscription-detail-container">
            ...
            <div className="methode-payment">
              ...
              <div className="cards-payment">
                <div className="card-contente">
                  ...
                  <h3>CIB ou Dahabiya</h3>
                </div>
                <div className="card-contente">
                  <div
                    className={
                      payement ? "card-payment" : "card-payment active-payment"
                    }
        ...
        <div className="subscription-detail-content">
          ...
          <div className="legals">
            <Link to="https://thunder-trilby-4f5.notion.site/Condition-g-n-rale-d-utilisation-7ad178be1cf04116980398349f661f93"  target="_blank">
              <div className="legal">
            ...
            <Link to="https://thunder-trilby-4f5.notion.site/Politique-de-confidentialit-64c54d9ced9548168fe8fd0be7db02fd" target="_blank">
              <div className="legal">
            ...
            <a href={selectedPlan.pdf} download>
              <div className="legal">
                <img src={contrat} alt="" />
                <div className="legal-text">
